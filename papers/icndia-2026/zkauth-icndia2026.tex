...
WebView measurements on two Android devices (Samsung Galaxy S23, $n=15$;
Samsung Galaxy Tab S9 FE+, $n=15$) are also reported.
...
two Android devices, snarkjs v0.7.4). Server verify includes 50\,ms
...
Mobile prove, Galaxy S23 ($n{=}15$)        & 236.0 & 254.0 & 419.0 & 42.4 \\
Mobile prove, Tab S9 FE+ ($n{=}15$)         & 295.0 & 361.0 & 603.0 & 67.1 \\
\midrule
...
hardware-dependent spread (254--361\,ms median) suggests production
deployments should budget for device-tier variance in UX design (e.g.,
progress indicators for proving operations exceeding 200\,ms).
...
and scroll telemetry alongside mouse dynamics; iOS WKWebView benchmarking to
complete cross-platform mobile coverage; circuit optimization for reduced
